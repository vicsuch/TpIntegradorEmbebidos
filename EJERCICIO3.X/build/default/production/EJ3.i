...
INICIO:
    ...
    bsf ((STATUS) and 07Fh), 5 ; Seleccionar banco 1
    movlw 0xFF ; Configurar ((PORTB) and 07Fh), 6 y ((PORTB) and 07Fh), 7 como entradas, el resto como salidas
    movwf TRISB
    movlw 0x00 ; Configurar ((PORTA) and 07Fh), 0 como salida, el resto como entradas
    movwf TRISA
    bcf ((STATUS) and 07Fh), 5 ; Seleccionar banco 0
...
CAMBIAR_ESTADO:
    ; Cambiar el estado del LED en ((PORTA) and 07Fh), 0
